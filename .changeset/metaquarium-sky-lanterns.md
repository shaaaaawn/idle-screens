...
Geode home fronts rebuilt: a round door in a ring of dressed stone — painted boards, strap hinges, a brass knob dead centre — under a small shingled porch on posts with a hanging lantern; a timber rim and uprights round the plank wall; framed, shuttered windows with a flower box; cheek walls on the steps. Each home's paint is the cottage colour furthest round the wheel from its own crystal (an orange geode gets a blue door).
