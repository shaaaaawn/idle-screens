...
const ALL_IDS = [
  'black-hole', 'tide', 'limelight', 'slipstream', 'toasters', 'dvd', 'warp', 'fish', 'rainstorm', 'hard-rain',
 ...
 * savers (black-hole, tide, limelight, slipstream, spotlight) may mutate the live page's victims while
