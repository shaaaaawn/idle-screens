  ...
  layers: [
    {
      key: 'flock-a',
      count: 260,
      sprite: { kind: 'streak', length: [0.004, 0.012], width: 0.0012, color: '#c9d4e6', colors: ['#c9d4e6', '#8fa6c4'], colorWeights: [2, 1] },
      motion: { type: 'wander', speed: [0.015, 0.06], meander: 0.05, coherence: 0.95 },
      alpha: [0.25, 0.6],
      blend: 'screen',
    },
    {
      ...
      key: 'flock-b',
      count: 260,
      sprite: { kind: 'streak', length: [0.006, 0.014], width: 0.0012, color: '#8fa6c4', colors: ['#8fa6c4', '#c9d4e6'], colorWeights: [2, 1] },
      motion: { type: 'wander', speed: [0.02, 0.05], meander: 0.045, coherence: 0.93 },
      alpha: [0.2, 0.5],
      blend: 'screen',
    },
    {
