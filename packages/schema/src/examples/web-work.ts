  ...
  layers: [
    {
      ...
      motion: { type: 'drift', speed: [0.002, 0.006], angle: 0, bidirectional: true },
      alpha: [0.45, 0.8],
      links: {
        k: 3,
        maxDist: 0.3,
    ...
    },
    {
      ...
      sprite: {
        kind: 'stroke',
        length: [0.02, 0.045],
        points: [[-1, 0.2], [-0.2, -0.5], [0.6, -0.3], [1, 0.1]],
        width: 0.0016,
        taper: true,
        orient: true,
        color: '#6f93b8',
      ...
      motion: { type: 'drift', speed: [0.01, 0.03], angle: 0, bidirectional: true },
      alpha: [0.3, 0.6],
    },
  ],
};
